      ...
      <form onSubmit={handleFormSubmit} className="flex flex-col gap-9">
        <label className="flex flex-col gap-3">
          ...
          <textarea
            ...
            rows={4}
            name="caption"
            className="bg-dark-300 resize-none p-4 outline-none bg-black"
          ...
          {imagesOrVideos.length ? (
            <div className="bg-dark-300 w-full flex-wrap flex gap-3 p-10">
              {imagesOrVideos.map((i, inx) => {
                ...
                return (
                  <div className="relative" key={inx}>
                    ...
                    <button
                      type="button"
                      className="absolute top-0 left-0 bg-red-500 text-white px-2"
                      onClick={() =>
                        setImagesOrVideos(
              ...
              <div className="absolute right-3 bottom-3 flex items-center space-x-5">
                <button
                  type="button"
                  className="font-semibold py-3 h-fit px-[20px] bg-purple w-fit mt-auto ml-auto rounded-lg bg-[#877EFF]"
        ...
        <label className="flex flex-col gap-3">
          ...
          <input
            name="content_alt"
            required
            className="bg-dark-300 p-4 outline-none bg-black"
        ...
        <button
          type="submit"
          className={`font-semibold py-3 px-[20px] bg-[#877EFF] bg-purple capitalize w-fit ml-auto rounded-lg ${
